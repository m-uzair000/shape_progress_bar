...
class PolygonBar extends StatefulWidget {
  final double size;
  final int points; // Number of corners: 3=triangle, 5=pentagon, 6=hexagon...
  ...
  @override
  _PolygonBarState createState() => _PolygonBarState();
}

class _PolygonBarState extends State<PolygonBar> with SingleTickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(covariant PolygonBar oldWidget) {
...
class _PolygonPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    final path = _createPolygonPath(size, points);
