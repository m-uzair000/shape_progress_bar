...
class _StarBarState extends State<StarBar>
  ...
  @override
  void didUpdateWidget(covariant StarBar oldWidget) {
  ...
  Path _createSharpStarPath(Rect rect, int points, double innerRadiusRatio) {
    final path = Path();
      ...
      builder: (context, _) {
        ...
        return CustomPaint(
          ...
          painter: _BorderPainter(
            ...
            createStarPath: (rect, points, innerRadiusRatio, cornerRadius) =>
                _createSharpStarPath(rect, widget.points, innerRadiusRatio),
          ),
          child: SizedBox(
            width: widget.size,
            height: widget.size,
...
class _BorderPainter extends CustomPainter {
  ...
  final Path Function(Rect rect, int points, double innerRadiusRatio,
      double cornerRadius) createStarPath;
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final starPath = createStarPath(rect, 5, 0.5, cornerRadius);
